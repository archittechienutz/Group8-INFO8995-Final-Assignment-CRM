...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'potential-space-doodle-rvvp94pjv9ghpgqw-8000.app.github.dev']
CSRF_TRUSTED_ORIGINS=['https://potential-space-doodle-rvvp94pjv9ghpgqw-8000.app.github.dev']
# Database
DATABASES = {
    'default': {
        # for MySQl
